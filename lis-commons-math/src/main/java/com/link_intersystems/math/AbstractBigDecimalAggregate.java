...
public abstract class AbstractBigDecimalAggregate implements Aggregate<BigDecimal> {
	 ...
	 * logic is:
	 * <ul>
	 * <li>If the {@link Number} is an instance of {@link BigDecimal} the casted
	 * instance will be passed to {@link #doAddValue(BigDecimal)}.</li>
	 * <li>If the {@link Number} is an instance of {@link BigInteger} a new
	 * {@link BigDecimal} is created and the {@link BigInteger} is passed to the
	 * {@link BigDecimal#BigDecimal(BigInteger)}'s constructor
	 * </ul>
	 * <li>In any other case the {@link Number} is interpreted as a double value
	 * and a new {@link BigDecimal} is created with that double value.
	 * </ul>
	 *
	 * @inherited
	 * @since 1.2.0;

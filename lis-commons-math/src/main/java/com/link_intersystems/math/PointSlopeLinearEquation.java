...
public class PointSlopeLinearEquation implements LinearEquation {
     ...
     *
     * @param slope the slope of the line.
     * @param b     the intersection point with the y axis.
     * @since 1.2.0;
     */
     ...
     *
     * @param slope the slope of the line.
     * @param x     x coordinate of a point on the linear equation.
     * @param y     y coordinate of a point on the linear equation.
     * @since 1.2.0;
     */
     ...
     *
     * @param slope          the slope of the line.
     * @param cartesianPoint the {@link CartesianPoint} that describes the x and y
    ...
    public PointSlopeLinearEquation(Slope slope, CartesianPoint cartesianPoint) {
        requireNonNull(slope);
        requireNonNull(cartesianPoint);
     ...
     *
     * @param slope      the slope of the line.
     * @param polarPoint the {@link PolarPoint} that describes the x and y coordinates.

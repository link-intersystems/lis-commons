 ...
 */
public class H2DatabaseStore {

    private ExtensionContext.Namespace namespace = ExtensionContext.Namespace.create(H2DatabaseStore.class);
    private H2DatabaseFactory h2DatabaseFactory;

    public H2DatabaseStore(H2DatabaseFactory h2DatabaseFactory) {

...
public class PropertyAccessException extends PropertyException {
    ...
    public PropertyAccessException(Class<?> beanType, String propertyName, PropertyAccessType accessType) {
        this(beanType, propertyName, accessType, null);
    }

    public PropertyAccessException(Class<?> beanType, String propertyName, PropertyAccessType accessType, Throwable cause) {

...
public class Class2<T> implements Serializable {
	 ...
	 *
	 * @param clazz
	 *            the class to get a {@link Class2} for.
	 */
	 ...
	 *            the arguments for creating an instance of this {@link Class2}
	 *            's type.
	 ...
	 *
	 * @param accessTypes
	 *            the {@link AccessType} that the selected constructor must
	 *            have.
	 *
	 * @since 1.0.0.0
	 */
	 ...
	 *             if no method matches the parameters.
	 * @since 1.0.0.0
	 */
	 ...
	 *
	 * @param signature
	 *            the {@link Signature} of the requested method
	 *
	...
	/**
	 * @param typeVariable
	 *            the {@link TypeVariable} to get the bounded type for.
	 * @return the type that is bound on this {@link Generic} type for the given
	 *         {@link TypeVariable} or null if the type is not bound on this
	 *         {@link Generic}'s type. If the bound type is a generic type the
	 ...
	 *             if no type variable definition could be found in this class's
	 *             hierarchy.
	 * @since 1.2.0.0
	 */
	 ...
	 *
	 * @param <TI>
	 *            the expected type so that clients must not cast.
	 * @param typeVariable
	 *            the type variable that defines the class to be instantiated.
	 * @param constructorArgs
	 *            the arguments to use when constructing the bound type.
	 ...
	 *             in case of an {@link InstantiationException},
	 ...
	 * @throws IllegalArgumentException
	 *             if the type bound to the type variable is an interface or the
	...
	private String typeParametersToString(TypeVariable<?>[] typeParameters) {
		...
		if (typeParameters.length > 0) {
			...
			String typeParametersToString = StringUtils.join(
					typeParametersAsStrings, ",");
			toStringBuilder.append(typeParametersToString);

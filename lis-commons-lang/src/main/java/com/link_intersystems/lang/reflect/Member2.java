...
public abstract class Member2<MEMBER_TYPE extends Member> implements Member,
		Serializable {
	...
	private final SerializableReference<MEMBER_TYPE> memberRef;

	private Member2Applicability member2Applicability;

	protected Member2(MEMBER_TYPE member) {

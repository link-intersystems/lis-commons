...
public class Method2 extends Member2<Method> {
    ...
    public Method getDefinition() {
        ...
        Predicate<Method> signaturePredicate = new SignaturePredicate<>(getMember());
        FilteredMethodIterator memberIterator = new FilteredMethodIterator(declaringClass, signaturePredicate);


        Method definition = null;

        if (memberIterator.hasNext()) {
            // The first method returned will be this method, since we start at the declaring class.
            definition = memberIterator.next();
        }

...
public class MethodInvokingTransformer implements Function<Object, Object> {
     ...
     * @since 1.2.0;
     */
    public MethodInvokingTransformer(Method2 methodToUse, InvocationArgumentsResolver invocationArgumentsResolver) {
        requireNonNull(methodToUse);
        requireNonNull(invocationArgumentsResolver);
     ...
     * @since 1.2.0;
     */
    public MethodInvokingTransformer(Method methodToUse, InvocationArgumentsResolver invocationArgumentsResolver) {
     ...
     * </p>
     *
     * @throws IllegalStateException if an exception occurs while invoking the transform method on
     *                               the input object.
     * @version 1.2.0;
     * @since 1.0.0;
     */

...
public class ContextAwareTest {
	...
	public void runnableWithUndeclaredException() throws Exception {
		final ContextProvider contextProvider = EasyMock
				.createStrictMock(ContextProvider.class);
	...
	public void proxy() throws Exception {
		...
		expect(targetInterface.concat("HELLO ", "WORLD")).andAnswer(
				new IAnswer<String>() {
					...
					public String answer() throws Throwable {
						...
						Method declaredMethod = TargetInterface.class
		...
		TargetInterface targetInterfaceContextAware = contextAware
				.createContextProxy(targetInterface);
		Method2 method = contextAware.getInvocationMethod();
	...
	public void contextJoinPoint() throws Exception {
		class TestContextJoinPoint implements ContextProvider {
			...
			public void provideContext(RunInContext contextJoinPoint)
					throws Exception {
	...
	public void invokeStaticMethod() throws Exception {
		final TestContextAware contextAware = new TestContextAware();
		Boolean runInContext = contextAware.invokeStaticInContext(
				StringUtils.class, "isEmpty", "");
		assertTrue(runInContext);
		assertFalse(contextAware.isActivated());
	}
	...
	public void invokeMethod() throws Exception {
		...
		replay(targetInterface);
		Object runInContext = contextAware.invokeInContext(targetInterface,
				"getString");
	...
	public void contextListenerTest() throws Exception {
		...
		runInContext = contextAware.invokeInContext(targetInterface,
				"getString");
		assertEquals("Hello World", runInContext);
		assertFalse(contextAware.isActivated());
		EasyMock.verify(targetInterface, contextListener);
